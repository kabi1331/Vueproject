          ...
          <Content :style="{padding: '24px', minHeight: '280px', background: '#fff'}">
            ...
            <ul class="forminfo">
              <li>
                ...
                <input name type="text" class="dfinput" v-model="productCode" />
              </li>
              <li>
                <label>
                  产品名称
              ...
              <li>
                ...
                <input name type="text" class="dfinput" v-model="unitName" />
              </li>
              <li>
                <label>
                  分类编号
                ...
                <input name type="text" class="dfinput" v-model="categoryId " />
              </li>
              <li>
                <label>
                  价格
                ...
                <input name type="text" class="dfinput" v-model="price" />
              </li>
              <li>
                <label>
                  添加日期
...
export default {
  ...
  methods: {
    ...
    add() {
      ...
      Axios.post("/api/main/sell/product/add", Qs.stringify(data)).then(
        resp => {
          this.$router.push("/classify");
        }
      );
