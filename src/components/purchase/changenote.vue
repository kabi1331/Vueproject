                ...
                <form action="#" id="pomainForm">
                  ...
                  <table class="tablelist">
                    <tr>
                      <td>采购单编号</td>
                      <td>
                        <input type="text" class="poinput" v-model="poId" />
                        <span>*</span>
                      </td>
                      <td>创建时间</td>
                      <td>
                      ...
                      <td>供应商</td>
                      <td>
                        <input type="text" class="poinput" v-model="venderCode" />
                        <span>*</span>
...
export default {
  ...
  mounted() {
    Axios.all([
      Axios.post(
        "/api/main/purchase/pomain/queryItem?poId=" + this.$route.params.id
      ),
      Axios.post(
        "/api/main/purchase/pomain/query?poId=" + this.$route.params.id
      )
    ]).then(
      Axios.spread((resp1, resp2) => {
        this.arr = resp1.data;
        this.showMessage = resp2.data.list;
        this.poId = this.showMessage[0].poId;
        this.venderCode = this.showMessage[0].venderCode;
