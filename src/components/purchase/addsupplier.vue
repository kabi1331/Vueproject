      ...
      <Layout>
        ...
        <Layout :style="{padding: '0 24px 24px'}">
          <Breadcrumb :style="{margin: '24px 0'}">
            ...
            <BreadcrumbItem>添加供应商</BreadcrumbItem>
          </Breadcrumb>
          <Content :style="{padding: '24px', minHeight: '280px', background: '#fff'}">
            ...
            <ul class="forminfo">
              <li>
                ...
                <input name type="text" class="dfinput" v-model="venderCode" />
              </li>
              <li>
                <label>
                  供应商名称
              ...
              <li>
                ...
                <input name type="text" class="dfinput" v-model="contactor" />
              </li>
              <li>
                <label>
                  添加日期
              ...
              <li>
                ...
                <input name type="text" class="dfinput" v-model="tel" />
              </li>
              <li>
                <label>
                  地址
                ...
                <input name type="text" class="dfinput" v-model="address" />
              </li>
              <li>
                <label>&nbsp;</label>
...
export default {
  ...
  mounted() {
    ...
    this.createDate = dayjs(nowDay).format("YYYY-MM-DD");
  },
  methods: {
    back() {
    ...
    add() {
      ...
      Axios.post("/api/main/purchase/vender/add", Qs.stringify(data)).then(
        resp => {
          this.$router.push("/supplier");
          console.log(resp);
